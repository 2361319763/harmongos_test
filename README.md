...
<p align="center">
	...
	<a href="https://gitee.com/476743842/jhm/blob/master/LICENSE"><img src="https://img.shields.io/github/license/mashape/apistatus.svg"></a>
</p>
...
本人是最近才刚开始学习鸿蒙Next的开发，就二周左右的时间，如有一些不足的地方，希望能多多交流纠正。

鸿蒙版本：HarmonyOS 5.0.1(13)
...
克隆代码后，使用鸿蒙开发工具直接打开就可以了

配置文件在 `entry/src/main/ets/config/Index.ets` 下面

需要将`baseUrl`改为自己的 若依后端服务地址或者直接用若依演示版本的也行
...
本人是码领10年+的全栈工程师，毛遂自荐一下，如果有些小项目可以联系一波，下面是擅长的技能：

后端开发/运维：Spring Boot、Spring Cloud、Docker、K8s、Jenkins ...

前端开发：Vue2、Vue3、React、原生 Html、Js、Css ...

移动端开发：Uniapp、Flutter、原生Android（Java）、原生IOS（OC）、原生微信小程序开发 ...

UI设计：学过设计，可使用 墨刀、摹客、PS 等一些工具直接设计
